...
public class ConGlaJobAdapter extends RecyclerView.Adapter<ConGlaJobAdapter.ConJobViewHolder> {
    @NonNull
    @Override
    public ConJobViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater rec2inflater = LayoutInflater.from(parent.getContext());
        View indiView = rec2inflater.inflate(R.layout.contact_openjob_rec_item,parent,false);
        return new ConJobViewHolder(indiView);
    }

    @Override
    public void onBindViewHolder(@NonNull ConJobViewHolder holder, int position) {
    ...
    class ConJobViewHolder extends RecyclerView.ViewHolder {
        ImageView arrow;
        ...
        public ConJobViewHolder(@NonNull View itemView) {
            super(itemView);
