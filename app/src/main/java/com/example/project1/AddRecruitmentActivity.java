...
public class AddRecruitmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_recruitment_activity);
        frameLayout = findViewById(R.id.add_recruitment_fragment);
        fragment = new AddRecruitFragment();
        fragmentManager = getSupportFragmentManager();
        fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.replace(R.id.add_recruitment_fragment, fragment);
    ...
    public void addFragmentOnTop(Fragment fragment, Bundle bundle) {
        ...
        getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.add_recruitment_fragment, fragment)
                .addToBackStack(null)
                .commit();
    }

    public void changeViewForSkills(){
    ...
    public void changeViewForRoles(){
        ImageView cardOuter = findViewById(R.id.imageView_2);
        cardOuter.setImageResource(R.drawable.circle_done);
    ...
    public void changeViewForPayment(){
