...
public class ClientHiresRecAdapter extends RecyclerView.Adapter<ClientHiresRecAdapter.ItemHHold> {
    ...
    public ClientHiresRecAdapter(int [] dot_img, String [] date, String [] typejob, String [] con_name, String [] con_mail, String [] rec, String [] rec_mail){
    ...
    public ItemHHold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ClientHiresRecAdapter.ItemHHold(indiView);
    }

    @Override
    public void onBindViewHolder(@NonNull ItemHHold holder, int position) {
